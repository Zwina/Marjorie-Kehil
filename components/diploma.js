    ...
    <div className="diploma-container " id="section1">
      ...
      <div>
        <Timeline>
              ...
              <Timeline.Body>
                <div className="flex items-center mt-4">
                  ...
                  <p className="ml-3">
                    ...
                    <br /> - Conception et mise en place d&apos;applications
                    web, mobiles et Desktop
                    <br /> - Développement back-end et front-end
                    d&apos;applications
                    <br /> - Modélisation conceptuelle et mise en place de base
                    de données
                    <br /> - Développement de composants dans le langage de base
                    de données
              ...
              <Timeline.Body>
                <div className="flex items-center mt-4">
                  ...
                  <p className="ml-3 leading-loose">
                    ...
                    <br />
                    <a
                      href="https://openclassrooms.com/fr/course-certificates/8994735090"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-yellow-300"
                    >
                    Implémentez vos bases de données relationnelles avec SQL </a>| OpenClassroom
                  </p>
                </div>
              </Timeline.Body>
              <Timeline.Body>
          ...
          <Timeline.Item>
            <Timeline.Point icon={HiCalendar} className="background: none" />
            <Timeline.Content className="ml-6">
              <Timeline.Title className="text-white">
              ...
              <Timeline.Body>
                <div className="flex items-center mt-4">
                  ...
                  <p className="ml-3 leading-loose">
                    <a
                      href="https://openclassrooms.com/fr/course-certificates/2967567534"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-yellow-300"
                    >
                    ...
                    <br />
                    <a
                      href="https://openclassrooms.com/fr/course-certificates/7844681514"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-yellow-300"
                    >
              ...
              <Timeline.Body>
                <div className="flex items-center mt-4">
                  ...
                  <p className="ml-3 leading-loose">
                    ...
                    | OpenClassroom
                    <br />
                    Apprenez à programmer en Java | OpenClassroom
                  </p>
                </div>
              </Timeline.Body>
            </Timeline.Content>
